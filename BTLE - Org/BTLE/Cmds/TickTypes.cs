...
namespace BTLE.Cmds
    ...
    */
    ...
    public struct ReplayRequest
        ...
        public readonly uint StartTime;             // 4 Bytes

        //Specifies the newest record to end with
        public readonly uint EndTime;               // 4 Bytes
        }
    ...
    public struct ReplayResponse
        ...
        public readonly uint EffectiveEnd;          // 4 Bytes
        }
