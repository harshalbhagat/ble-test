...
namespace BTLE.Misc
    ...
    public class BluetoothLEAttributeeDisplay
        {
    ...
    // These enums are nicer than the GattServiceUuids class  
    // which provides only convenient static constants for a limited number of UUIDs
    ...
    // These enums are nicer than the GattCharacteristicUuids class  
    // which provides only convenient static constants for a limited number of UUIDs
